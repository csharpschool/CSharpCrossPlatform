...
public class SubstancesTests
{
    ...
    {
        Substance substance = new Liquid("Water", 1);
    ...
    {
        Substance substance = new Plasma("Lightning", 1);
    ...
    {
        Substance substance = new Solid("Ice", 0.9);
    ...
    {
        Substance substance = new Gas("Air", 0.1);
